...
![Screenshot from 2023-07-13 13-12-10.png](images/2d2d5fcc9465988903a35a781f4ee3661f2ee4ce.png)

![Screenshot from 2023-07-13 13-12-39.png](images/f62d397e52ca420cd41f291415a8505750a1edb5.png)

![Screenshot from 2023-07-13 13-13-15.png](images/7e7faccd2b54ea7ad249495c45472d8a9a7d6003.png)
...
<img src="images/a81bee42b9253d673ef24df8b152619d26537e0a.png" title="" alt="IMG_6984.png" width="445">

Here's what the router looks like inside:

![IMG_6990.png](images/6fe21cb379e3f991c3312e1282b87d468a0cca26.png)
...
![IMG_6998.png](images/048f922c1a3e162eb3d2bace5a2368f4757e342b.png)

• Run the following command to install minicom:

sudo apt-get install minicom

![Screenshot from 2023-07-13 13-22-15.png](images/b20d54055a06cdf021eaa8d612edd8ccebf571c4.png)

• Attach your USB serial interface to your computer.

![IMG_7002.png](images/b0ec3f9d7c17974cf0eedcc814701b89bade96d9.png)

• Open a terminal window and run the following command:

minicom -D /dev/ttyUSB0 -c on

![Screenshot from 2023-07-13 13-24-01.png](images/31188b4c28e1c32c2273e2236be5da47c3badd3b.png)
...
![Screenshot from 2023-07-13 13-24-51.png](images/582df64a24bd07fd487ca76c0da71ea30b528c47.png)
...
![IMG_7019__.png](images/06569221e3972a22b7316c57b5a7c375205a512a.png)

![IMG_7011.png](images/293b270e4f1c05ea8c294a7ad60fe2133ad79c02.png)

• Touch the plug end your Tx jumper wire to the Rx pin indicated in the photo below. Hold it there firmly for the next step.

![IMG_7020.png](images/262b6ef61a6e2933b5b7c6536a51bf59b7c202c7.png)
...
![Screenshot from 2023-07-13 13-31-47.png](images/24860dc112ca8ce392b8841e6a8bcab43ecdf7c4.png)

• Click **Browse ...** and select the firmware file, **AtlasMediaOpenWrt.trx**.

• Click **Upload** to start uploading the file.

![Screenshot from 2023-07-13 13-32-05.png](images/7e73de9f6d2082d4b7fc8e6b3b344bc3fbeff9d7.png)

• When you see the page below, it means your firmware has been uploaded successfully.

![Screenshot from 2023-07-13 13-32-46.png](images/8e7c19066365ef0fc58d09460905f39dbadddfb0.png)

• Wait a minute or two for OpenWrt to finish setting up, then go the following address in your browser:
http://192.168.1.1

![Screenshot from 2023-07-13 13-35-17.png](images/2d03574321a0b618ba1b850e16371c83b3e628cd.png)

• There's isn't a password set by default. Press enter to log in.

• Set a new password.

![Screenshot from 2023-07-13 13-35-25.png](images/6de9ab2666529d68a3c30a699e372956c9434236.png)
